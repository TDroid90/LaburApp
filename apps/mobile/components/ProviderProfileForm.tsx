...
export function ProviderProfileForm({ initialProfile, email, busy, remoteError, onCancel, onSubmit }: {
    ...
    <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
      ...
      {services.map((item, index) => <View key={item.id} style={styles.serviceCard}>
        ...
        <View style={[styles.serviceDataRow, compact && styles.fieldsColumn]}>
          ...
          <TimeStepper label="DESDE" value={item.startTime} onChange={(startTime) => updateService(item.id, { startTime })} />
          <TimeStepper label="HASTA" value={item.endTime} onChange={(endTime) => updateService(item.id, { endTime })} />
        </View>
      </View>)}
...
const styles = StyleSheet.create({
  card: { backgroundColor: "white", borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 20, paddingBottom: 24, maxHeight: "96%" }, eyebrow: { color: "#FF7800", fontSize: 11, fontWeight: "900", letterSpacing: 0.8 }, title: { color: "#063C78", fontSize: 25, fontWeight: "900", marginTop: 3 }, copy: { color: "#5E7183", fontSize: 12, lineHeight: 17, marginTop: 4, marginBottom: 7 }, scroll: { maxHeight: 650 }, scrollContent: { paddingBottom: 12 }, sectionTitle: { color: "#063C78", fontSize: 16, fontWeight: "900", marginTop: 12, marginBottom: 8 }, identityRow: { flexDirection: "row", alignItems: "center", marginBottom: 12 }, photo: { width: 68, height: 68, borderRadius: 34, marginRight: 13 }, photoFallback: { width: 68, height: 68, borderRadius: 34, backgroundColor: "#063C78", alignItems: "center", justifyContent: "center", marginRight: 13 }, photoInitial: { color: "white", fontSize: 27, fontWeight: "900" }, identityFields: { flex: 1 }, photoButton: { minHeight: 38, alignSelf: "flex-start", justifyContent: "center", paddingHorizontal: 13, borderWidth: 1, borderColor: "#078EE9", borderRadius: 10 }, photoButtonText: { color: "#078EE9", fontSize: 12, fontWeight: "900" }, email: { color: "#5E7183", fontSize: 11, marginTop: 7 }, fieldsRow: { flexDirection: "row", gap: 8 }, fieldsColumn: { flexDirection: "column" }, flexField: { flex: 1 }, input: { minHeight: 46, borderWidth: 1, borderColor: "#D6E8F2", borderRadius: 11, paddingHorizontal: 12, color: "#063C78", backgroundColor: "#FBFDFE", marginBottom: 8 }, label: { color: "#063C78", fontSize: 12, fontWeight: "900", marginTop: 5, marginBottom: 6 }, help: { color: "#5E7183", fontSize: 10, lineHeight: 14, marginTop: -3, marginBottom: 8 }, multiline: { minHeight: 76, paddingTop: 11, textAlignVertical: "top" }, multilineSmall: { minHeight: 62, paddingTop: 11, textAlignVertical: "top" }, servicesHeading: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 10, marginTop: 2 }, freeBadge: { color: "#16825B", backgroundColor: "#E7F7F0", paddingHorizontal: 9, paddingVertical: 5, borderRadius: 12, fontSize: 10, fontWeight: "900" }, serviceCard: { borderWidth: 1, borderColor: "#CFE4EE", backgroundColor: "#F8FCFE", borderRadius: 14, padding: 11, marginTop: 8 }, serviceTop: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 7 }, serviceNumber: { color: "#078EE9", fontSize: 10, fontWeight: "900", letterSpacing: 0.4 }, remove: { color: "#B7452B", fontSize: 10, fontWeight: "900" }, selector: { minHeight: 44, borderWidth: 1, borderColor: "#D6E8F2", backgroundColor: "white", borderRadius: 10, flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingHorizontal: 11 }, selectorText: { color: "#063C78", fontSize: 12, fontWeight: "800", flex: 1 }, chevron: { color: "#078EE9", fontSize: 17, fontWeight: "900" }, options: { maxHeight: 230, borderWidth: 1, borderColor: "#D6E8F2", borderRadius: 10, overflow: "hidden", marginTop: 5, backgroundColor: "white" }, option: { minHeight: 37, justifyContent: "center", paddingHorizontal: 11, borderBottomWidth: 1, borderBottomColor: "#EDF4F7" }, optionActive: { backgroundColor: "#E8F6FD" }, optionText: { color: "#5E7183", fontSize: 11 }, optionTextActive: { color: "#063C78", fontWeight: "900" }, serviceDataRow: { flexDirection: "row", gap: 8, marginTop: 9 }, priceWrap: { flex: 1.45 }, timeWrap: { flex: 1 }, miniLabel: { color: "#5E7183", fontSize: 9, fontWeight: "900", marginBottom: 4 }, money: { minHeight: 42, flexDirection: "row", alignItems: "center", borderWidth: 1, borderColor: "#D6E8F2", borderRadius: 9, backgroundColor: "white", paddingHorizontal: 8 }, currency: { color: "#5E7183", fontSize: 9, fontWeight: "900" }, priceInput: { flex: 1, color: "#063C78", fontWeight: "900", paddingHorizontal: 5 }, timeControl: { minHeight: 42, flexDirection: "row", alignItems: "center", justifyContent: "space-between", borderWidth: 1, borderColor: "#D6E8F2", borderRadius: 9, backgroundColor: "white", overflow: "hidden" }, timeButton: { width: 34, height: 40, alignItems: "center", justifyContent: "center", backgroundColor: "#EEF7FB" }, timeButtonText: { color: "#078EE9", fontSize: 17, fontWeight: "900" }, timeValue: { color: "#063C78", fontSize: 11, fontWeight: "900" }, addService: { minHeight: 44, borderWidth: 1, borderStyle: "dashed", borderColor: "#078EE9", borderRadius: 11, alignItems: "center", justifyContent: "center", marginTop: 9 }, addServiceText: { color: "#078EE9", fontSize: 12, fontWeight: "900" }, lockedService: { minHeight: 58, borderRadius: 11, backgroundColor: "#F1F4F6", marginTop: 9, paddingHorizontal: 12, flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 8, opacity: 0.78 }, lockedTitle: { color: "#5E7183", fontSize: 12, fontWeight: "900" }, lockedText: { color: "#758795", fontSize: 10, marginTop: 2 }, membershipBadge: { color: "#9A4700", fontSize: 9, fontWeight: "900", backgroundColor: "#FFF3E8", borderRadius: 9, paddingHorizontal: 7, paddingVertical: 4 }, planNote: { color: "#6D5B45", backgroundColor: "#FFF7E9", borderRadius: 9, padding: 9, fontSize: 10, lineHeight: 15, marginTop: 9 }, error: { color: "#B7452B", fontSize: 12, fontWeight: "800", marginTop: 7 }, actions: { flexDirection: "row", gap: 8, marginTop: 12 }, cancel: { minHeight: 48, minWidth: 92, borderWidth: 1, borderColor: "#078EE9", borderRadius: 11, alignItems: "center", justifyContent: "center" }, cancelText: { color: "#078EE9", fontWeight: "900" }, save: { flex: 1, minHeight: 48, borderRadius: 11, backgroundColor: "#FF7800", alignItems: "center", justifyContent: "center" }, saveText: { color: "white", fontWeight: "900" }, disabled: { opacity: 0.55 },
});
