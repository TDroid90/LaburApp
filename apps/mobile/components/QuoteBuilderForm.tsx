...
import type { QuotePricingMode, SavedQuote, SavedQuoteItem, SavedRequest } from "../lib/local-store";
...
export function QuoteBuilderForm({ request, onCancel, onSubmit }: { request: SavedRequest; onCancel: () => void; onSubmit: (quote: Omit<SavedQuote, "version">) => void }) {
